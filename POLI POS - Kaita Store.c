...
int main(void){
        ...
        while (1) {
            ...
            while (estadoCaja == 0) {
                ...
                if (estadoCaja == 0) {
                    ...
                    printf("La caja sigue cerrada. Desea intentar abrirla (1=Si, 0=Salir): ");
                    int seguir;
        ...
        switch (opcionSwitch){
            ...
            case 7:
                ...
                printf("El IVA actual es del %%%.2f\n", IVA * 100);

                printf("Digite el nuevo IVA a aplicar: \n");
                scanf("%f", &IVA);

                printf("El IVA ha cambiado a %%%.2f", IVA * 100);
